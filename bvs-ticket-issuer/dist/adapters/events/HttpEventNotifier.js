...
exports.HttpEventNotifier = void 0;
const pino_1 = __importDefault(require("pino"));
const logger = (0, pino_1.default)({ name: 'HttpEventNotifier' });
class HttpEventNotifier {
    webhookUrl;
...
exports.HttpEventNotifier = HttpEventNotifier;
